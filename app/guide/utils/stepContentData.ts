...
export const stepContentMap: Record<string, StepContentData> = {
  ...
  'project': {
    ...
    preCodeText: '프로젝트를 저장할 폴더로 이동 후 이 명령어를 실행하세요:',
    codeBlocks: [{
      code: 'claude code new my-first-project',
      type: 'project_creation',
      action: 'create_first_project'
    }],
    postCodeText: '💡 프로젝트 이름은 원하는 대로 변경할 수 있습니다.',
    verifyText: '프로젝트가 생성되면 다음과 같은 메시지가 나타납니다:',
    verifyCommand: 'ls my-first-project',
    terminalExample: 'project-created',
    successButton: {
      title: '프로젝트 폴더가 생성됨',
      description: '새 폴더가 만들어졌습니다'
    },
    errorButton: {
      title: '오류 발생',
  ...
  'project-windows': {
    ...
    postCodeText: '💡 프로젝트 이름은 원하는 대로 변경할 수 있습니다.',
    verifyText: '프로젝트가 생성되면 다음과 같은 메시지가 나타납니다:',
    verifyCommand: 'dir my-first-project',
    terminalExample: 'project-created',
    successButton: {
      title: '프로젝트 폴더가 생성됨',
      description: '새 폴더가 만들어졌습니다'
